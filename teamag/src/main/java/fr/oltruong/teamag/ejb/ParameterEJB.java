...
public class ParameterEJB extends AbstractEJB {
    ...
    public void saveAndReloadParameters(Parameter smtpHostParameter,
	    Parameter administratorEmailParameter) {
	...
	if (CollectionUtils.isNotEmpty(parameterList)) {
	    this.parameterMap = new HashMap<ParameterName, Parameter>(
		    parameterList.size());
	...
	Parameter administratorEmailParameter = new Parameter(
		ParameterName.ADMINISTRATOR_EMAIL);
	...
	this.parameterMap.put(ParameterName.ADMINISTRATOR_EMAIL,
		administratorEmailParameter);
    ...
    private void setAdministratorEmailParameter(
	    Parameter administratorEmailParameter) {
	this.parameterMap.put(ParameterName.ADMINISTRATOR_EMAIL,
		administratorEmailParameter);
