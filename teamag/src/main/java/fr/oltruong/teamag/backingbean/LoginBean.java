...
public class LoginBean {
	...
	if (member != null) {
	    ...
	    userMessage = new FacesMessage(FacesMessage.SEVERITY_INFO,
	    ...
	    userMessage = new FacesMessage(FacesMessage.SEVERITY_ERROR,
		    this.username + " inconnu(e)",
		    "merci de réessayer ou contacter l'administrateur.");
	...
	FacesMessage userMessage = new FacesMessage(FacesMessage.SEVERITY_INFO,
		"Au revoir " + this.username, "à la prochaine!");
